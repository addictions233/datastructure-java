...
public class BinarySearchTree<E> implements BinaryTreeInfo { // 实现BinaryTreeInfo是为了能够打印二叉搜索树
     ...
     *     泛型为什么可以这么写? E extends Comparable规定了类型的上限  E super Comparable规定了类型的下限
     *        1, BinarySearchTree集合中元素必须具备可比较性,所以类型变量E必须继承自Comparable接口,重写ComparableTo()方法
     ...
     *          直接写成 E extends Comparable<E>和 E extends Comparable<? super E>都是可以的 super规定了类型的下限
     */
